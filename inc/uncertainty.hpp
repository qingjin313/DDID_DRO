...
protected:
    ...
    /** vector for the associated observation decision variables*/
    std::vector<int> obsVar;
...
public:
    ...
    /**
     * Assign the observation variables to the uncertaint parameter
     * @param  obsVarInput  pair of uncertain parameter index and observation variable index
     */
    void setObsVar(const std::pair<int, int>& obsVarInput);
    
    /**
     * Set w \circ \xi = w \circ \bar{\xi}
     * @param  xi_bar   input sample
     */
    void setXiBar(const std::vector<double>& xi_bar);
    
    /**
     * Reset the uncertainty set
     */
    void resetXiBar();
     ...
     * @return  vector w
     */
    inline std::vector<bool> getVectorW() const {return w;}
    
    /**
     * Get size of vector w
     * @return size of vector w
     */
    inline int getWSize() const {return w.size();}
